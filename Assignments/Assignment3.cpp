...
if (userChoice == 2) {      // if the user picks paper
...
if (userChoice == 3) {            // if the user picks scissors
...
if (userChoice == 4) {                  // if the user picks lizard
...
if (userChoice == 5) {                  // if the user picks spock
...
Ties = (5 - userWins - compWins);   //Wanted to keep track of ties.
